...
public class FigureGameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*记完了*/
        Button FiguerStep = findViewById(R.id.switch_figure_btn);

        /* 提交答案*/
        FiguerStep.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(FigureGameActivity.this,ExamActivity.class);

                /*获取wzi_text的值*/
                TextView editText2 = findViewById(R.id.wzi_text);
